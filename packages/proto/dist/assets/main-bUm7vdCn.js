import{i as v,O as T,r as d,h as b,a as h,x as n,b as k,V as _,n as c,d as O,f as D,c as N,e as S,_ as R,s as Y}from"./headings.css-ssStuQj-.js";var G=Object.defineProperty,Z=(o,e,r,t)=>{for(var a=void 0,i=o.length-1,s;i>=0;i--)(s=o[i])&&(a=s(e,r,a)||a);return a&&G(e,r,a),a};const $=class $ extends v{constructor(){super(...arguments),this._authObserver=new T(this,"parks:auth")}connectedCallback(){super.connectedCallback(),this._authObserver.observe(e=>{this._user=e.user})}render(){var e;return n`
      <header>
    ...
    `}handleSignOut(e){e.preventDefault(),this.dispatchEvent(new CustomEvent("auth:message",{bubbles:!0,composed:!0,detail:["auth/signout"]})),window.location.href="/login.html"}};$.styles=[d.styles,b.styles,h`
      :host {
        display: block;
        padding: 2rem 1rem;
    ...
    `];let m=$;Z([k()],m.prototype,"_user");const I=class I extends v{render(){return n`
    ...
    `:n`<p>No park specified</p>`}};f.uses=O({"mu-form":D.Element}),f.styles=[d.styles,b.styles,h`
      main {
        max-width: 720px;
        margin: 0 auto;
        padding: 2rem 1rem;
    ...
    `];let g=f;L([c({attribute:"park-id"})],g.prototype,"parkId",2);L([k()],g.prototype,"park",1);var H=Object.defineProperty,K=(o,e,r,t)=>{for(var a=void 0,i=o.length-1,s;i>=0;i--)(s=o[i])&&(a=s(e,r,a)||a);return a&&H(e,r,a),a};const P=class P extends v{renderSection(e,r,t,a){return t!=null&&t.length?n`
      <section>
        <h2>
    ...
    `];let u=P;K([c({attribute:!1})],u.prototype,"park");var U=Object.defineProperty,w=(o,e,r,t)=>{for(var a=void 0,i=o.length-1,s;i>=0;i--)(s=o[i])&&(a=s(e,r,a)||a);return a&&U(e,r,a),a};const z=class z extends v{render(){const e=!!(this.linkLabel&&this.href);return n`
      <article class="card">
    ...
    `];let l=z;w([c({attribute:"img-src"})],l.prototype,"imgSrc");w([c()],l.prototype,"href");w([c()],l.prototype,"subtitle");w([c({attribute:"link-label"})],l.prototype,"linkLabel");const J={};function V(o,e,r){switch(o[0]){case"park/request":{const{parkId:t}=o[1];return[{...e,park:void 0,error:void 0},Q(t,r).then(a=>["park/load",{park:a}]).catch(a=>["park/error",{error:a.message}])]}case"park/load":{const{park:t}=o[1];return{...e,park:t,error:void 0}}case"park/error":return{...e,error:o[1].error};case"park/save":{const[,t,a]=o,{parkId:i,park:s}=t,A=e.park||{};return[e,X(i,{...A,...s},r,a).then(y=>["park/load",{park:y}]).catch(y=>["park/error",{error:y.message}])]}default:return e}}function Q(o,e){const r=S.headers(e);return fetch(`/api/parks/${o}`,{headers:r}).then(t=>{if(t.status===200)return t.json();throw new Error(`Failed to load park (${t.status})`)})}function X(o,e,r,t){return fetch(`/api/parks/${o}`,{method:"PUT",headers:{"Content-Type":"application/json",...S.headers(r)},body:JSON.stringify(e)}).then(a=>{if(a.status===200)return a.json();throw new Error(`Failed to save park (${a.status})`)}).then(a=>{var i;return(i=t==null?void 0:t.onSuccess)==null||i.call(t),a}).catch(a=>{var i;throw(i=t==null?void 0:t.onFailure)==null||i.call(t,a),a})}const E=[{path:"/app/park/:parkId/edit",view:o=>n`
      <park-edit park-id=${o.parkId}></park-edit>
    `},{path:"/app/park/:parkId",view:o=>n`
      <park-view park-id=${o.parkId}></park-view>
    `},{path:"/app",view:()=>n` <home-view></home-view> `},{path:"/",redirect:"/app"}];O({"mu-auth":S.Provider,"mu-history":N.Provider,"mu-store":class extends Y.Provider{constructor(){super(V,J,"parks:auth")}},"mu-switch":class extends R.Element{constructor(){super(E,"parks:history","parks:auth")}},"parks-header":m,"home-view":x,"park-view":p,"park-edit":g,"park-grid":u,"park-card":l});

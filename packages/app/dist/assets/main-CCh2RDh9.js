import{i as b,O as Y,r as p,h as k,a as h,x as n,b as u,V as O,n as c,d as T,f as R,c as L,e as S,_ as G,s as Z}from"./headings.css-ssStuQj-.js";var M=Object.defineProperty,N=(i,e,r,t)=>{for(var a=void 0,o=i.length-1,s;o>=0;o--)(s=i[o])&&(a=s(e,r,a)||a);return a&&M(e,r,a),a};const _="parks:theme",$=class $ extends b{constructor(){super(...arguments),this._theme="light",this._authObserver=new Y(this,"parks:auth")}connectedCallback(){super.connectedCallback(),this._authObserver.observe(r=>{this._user=r.user});const e=typeof localStorage<"u"&&localStorage.getItem(_)||null;this.applyTheme(e||this._theme)}render(){var e;return n`
    ...
    `:n`<p>No park specified</p>`}};v.uses=T({"mu-form":R.Element}),v.styles=[p.styles,k.styles,h`
      main {
        max-width: 720px;
        margin: 0 auto;
        padding: 2rem 1rem;
    ...
    `];let m=v;A([c({attribute:"park-id"})],m.prototype,"parkId",2);A([u()],m.prototype,"park",1);var K=Object.defineProperty,U=(i,e,r,t)=>{for(var a=void 0,o=i.length-1,s;o>=0;o--)(s=i[o])&&(a=s(e,r,a)||a);return a&&K(e,r,a),a};const P=class P extends b{renderSection(e,r,t,a,o=!1){return t!=null&&t.length?n`
      <section>
        <h2>
    ...
    `:null}render(){const e=this.park;if(!e)return n`<p>Loading park details...</p>`;const r=e.hikes??[],t=e.viewpoints??[],a=e.lodging??[],o=e.activities??[];return n`
      ${this.renderSection("Top Hikes","icon-hike",r,void 0,!0)}
    ...
    `];let f=P;U([c({attribute:!1})],f.prototype,"park");var J=Object.defineProperty,w=(i,e,r,t)=>{for(var a=void 0,o=i.length-1,s;o>=0;o--)(s=i[o])&&(a=s(e,r,a)||a);return a&&J(e,r,a),a};const z=class z extends b{render(){const e=!!(this.linkLabel&&this.href);return n`
      <article class="card">
    ...
    `];let l=z;w([c({attribute:"img-src"})],l.prototype,"imgSrc");w([c()],l.prototype,"href");w([c()],l.prototype,"subtitle");w([c({attribute:"link-label"})],l.prototype,"linkLabel");const V={};function Q(i,e,r){switch(i[0]){case"park/request":{const{parkId:t}=i[1];return[{...e,park:void 0,error:void 0},E(t,r).then(a=>["park/load",{park:a}]).catch(a=>["park/error",{error:a.message}])]}case"park/load":{const{park:t}=i[1];return{...e,park:t,error:void 0}}case"park/error":return{...e,error:i[1].error};case"park/save":{const[,t,a]=i,{parkId:o,park:s}=t,D=e.park||{};return[e,X(o,{...D,...s},r,a).then(y=>["park/load",{park:y}]).catch(y=>["park/error",{error:y.message}])]}default:return e}}function E(i,e){const r=S.headers(e);return fetch(`/api/parks/${i}`,{headers:r}).then(t=>{if(t.status===200)return t.json();throw new Error(`Failed to load park (${t.status})`)})}function X(i,e,r,t){return fetch(`/api/parks/${i}`,{method:"PUT",headers:{"Content-Type":"application/json",...S.headers(r)},body:JSON.stringify(e)}).then(a=>{if(a.status===200)return a.json();throw new Error(`Failed to save park (${a.status})`)}).then(a=>{var o;return(o=t==null?void 0:t.onSuccess)==null||o.call(t),a}).catch(a=>{var o;throw(o=t==null?void 0:t.onFailure)==null||o.call(t,a),a})}const ee=[{path:"/app/park/:parkId/edit",view:i=>n`
      <park-edit park-id=${i.parkId}></park-edit>
    `},{path:"/app/park/:parkId",view:i=>n`
      <park-view park-id=${i.parkId}></park-view>
    `},{path:"/app",view:()=>n` <home-view></home-view> `},{path:"/",redirect:"/app"}];T({"mu-auth":S.Provider,"mu-history":L.Provider,"mu-store":class extends Z.Provider{constructor(){super(Q,V,"parks:auth")}},"mu-switch":class extends G.Element{constructor(){super(ee,"parks:history","parks:auth")}},"parks-header":g,"home-view":x,"park-view":d,"park-edit":m,"park-grid":f,"park-card":l});
